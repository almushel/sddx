...
set sdl_lib=%sdl_dir%/bin/Debug/SDL2.lib
set sdl_main=%sdl_dir%/bin/Debug/SDL2main.lib

pushd %sdl_dir%
cmake -S ./ -B bin

pushd bin
msbuild SDL2.sln -p:Configuration=Debug -clp:ErrorsOnly
popd
popd
...
pushd bin
msbuild SDL2_mixer.vcxproj -p:Configuration=Debug -clp:ErrorsOnly
popd
